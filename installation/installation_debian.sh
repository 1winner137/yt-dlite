#!/bin/bash
# Linux/Ubuntu Installation Script (installation.sh)

echo "===== YT-DLite Installation for Linux/Ubuntu ====="

# Check for Python
if ! command -v python3 &> /dev/null; then
    echo "Python is not installed."
    echo "Please install Python with: sudo apt install python3 python3-pip"
